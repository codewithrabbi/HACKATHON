  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-surface/80 backdrop-blur-xl border border-line rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        <h2 className="font-display text-3xl mb-2 relative z-10 text-paper">Create account</h2>
        <p className="text-muted text-sm mb-8 relative z-10">Start auditing your business data today.</p>
        ...
        <form onSubmit={handleRegister} className="relative z-10 space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-mono text-muted mb-2 uppercase tracking-wider">First Name</label>
              <input 
                type="text" 
                value={firstName}
            ...
            <div>
              <label className="block text-xs font-mono text-muted mb-2 uppercase tracking-wider">Last Name</label>
              <input 
                type="text" 
                value={lastName}
          ...
          <div>
            <label className="block text-xs font-mono text-muted mb-2 uppercase tracking-wider">Work Email</label>
            <input 
              type="email" 
              value={email}
        ...
        <p className="text-center text-sm text-muted mt-8 relative z-10">
          Already have an account? <Link href="/login" className="text-paper hover:text-brass transition-colors">Log in</Link>
        </p>
      </div>
    </div>
  );
