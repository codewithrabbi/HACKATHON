...
export default function DashboardPage() {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      // 5. Revenue Chart Section
      drawSectionHeader("Revenue Trend Analysis", "30-DAY PERFORMANCE");
      ...
      if (chartElement) {
        try {
          ...
          // If the chart doesn't fit on the current page, add a new page
          if (currentY + finalHeight > pageHeight - margin) {
            doc.addPage();
            currentY = margin;
          }
          
          doc.addImage(imgData, "PNG", margin, currentY, contentWidth, finalHeight);
      ...
      doc.text("Generated by Synaptix AI", pageWidth - margin, pageHeight - 22, { align: "right" });
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-surface/80 backdrop-blur-xl border border-line rounded-3xl p-6 shadow-2xl relative flex flex-col h-full">
          ...
          <div className="flex-1 min-h-[280px]" id="dashboard-revenue-chart">
